...
public class CreateProduct {
	...
	public CreateProduct(SessionFactory sessionFactory) {
		...
		Product p1 = new Product("PS5",new BigDecimal("40000.0"),20,c1);
		Product p2 = new Product("Table Tennis Bat",new BigDecimal("500.50"),10,c2);
		Product p3 = new Product("Marvel Secret Wars",new BigDecimal("1000.0"),50,c3);
