...
public class CreateOrders {
	...
	public CreateOrders(SessionFactory sessionFactory)
	{
		...
		//create order
		Orders o1 = new Orders(LocalDateTime.now(),new BigDecimal("10567.56"),u1);
		session.persist(o1);
		System.out.println("Order1 created for User1 with ID: " + o1.getId());
		
		//create order details
		OrderDetails od1 = new OrderDetails(6, 500.0, o1, p1);
		OrderDetails od2 = new OrderDetails(10, 2500.50, o1, p2);
		session.persist(od1);
		session.persist(od2);
		...
		//create order details
		OrderDetails ord = new OrderDetails(5, 750.50, o2, p3);
		session.persist(ord);
